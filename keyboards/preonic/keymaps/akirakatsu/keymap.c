...
/* Qwerty
 ...
 |-------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 |  Ctrl |   GUI  |   Alt  |  Lower |      Space      |      Space      |  Left  |  Down  |   Up   |  Right |
 `----------------------------------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_preonic_grid(
  ...
  KC_LCTL, KC_LGUI, KC_LALT,   LOWER,  KC_SPC,  KC_SPC,  KC_SPC,  KC_SPC, KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT
),
...
/* Lower
 ...
 |  PgDn |        |        |        |        |  Debug |        |        |        |        |        |        |
 |-------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 |       |        |        |        |      Space      |      Space      |  Prev  |  VolDm |  VolUp |  Next  |
 `----------------------------------------------------------------------------------------------------------'
 */
[_LOWER] = LAYOUT_preonic_grid(
  ...
  _______, _______, _______, _______,  KC_SPC,  KC_SPC,  KC_SPC,  KC_SPC, KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT
)
};